...
namespace PlazaRepository.Data.Migrations
{
    ...
    [Migration("20251111115751_addArDescriptionAndTictok")]
    partial class addArDescriptionAndTictok
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlazaCore.Entites.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PlazaCore.Entites.Hotel", b =>
                {
                    ...
                    b.Property<int>("NumOfAvailableRoomsToReserve")
                        .HasColumnType("int");

                    b.Property<int>("NumOfAvailableSuitesToReserve")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PlazaCore.Entites.InsightHotel", b =>
                {
                    ...
                    b.Property<string>("CafeDescriptionAr")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("RestaurantDescriptionAr")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PlazaCore.Entites.Partners", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PlazaCore.Entites.ApplicationUser", null)
                        .WithMany()
